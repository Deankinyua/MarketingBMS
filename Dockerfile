...
# set build ENV
ENV MIX_ENV="prod"
ENV SECRET_KEY_BASE="1JqLfroMq4q+ooZNpYXyIEp52NjayjqO5aJorOXQZVFM+gJ1r9mll453wfTPeejj"
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/marketingbsm ./
