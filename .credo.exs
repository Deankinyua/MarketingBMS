        ...
        enabled: [
          ...
          {Credo.Check.Design.AliasUsage,
           [
             ...
             files: %{
               excluded: [
                 "lib/marketingbsm_web/components/core_components.ex"
               ]
             }
           ]},
          ...
          {Credo.Check.Readability.Specs,
           files: %{
             excluded: [
               "lib/marketingbsm_web.ex",
               "lib/marketingbsm_web/components/core_components.ex",
               "lib/marketingbsm_web/controllers/error_html.ex",
               "lib/marketingbsm_web/controllers/error_json.ex"
             ]
           }},
