...
config :marketingbsm, MarketingbsmWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: MarketingbsmWeb.ErrorHTML, json: MarketingbsmWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Marketingbsm.PubSub,
  live_view: [signing_salt: "JaATJuoF"]
