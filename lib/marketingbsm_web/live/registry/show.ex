defmodule MarketingbsmWeb.RegistryLive.Show do
  ...
  def render(assigns) do
    ...
    <.header>
      ...
      <:actions>
        <.link patch={~p"/registries/#{@registry}/show/edit"} phx-click={JS.push_focus()}>
    ...
    <.back navigate={~p"/registries"}>Back to registries</.back>

    <.modal
      :if={@live_action == :edit}
      id="registry-modal"
      show
      on_cancel={JS.patch(~p"/registries/#{@registry}")}
    >
      <.live_component
