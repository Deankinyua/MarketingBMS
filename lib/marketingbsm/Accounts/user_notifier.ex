defmodule Marketingbsm.Accounts.UserNotifier do
  # import Swoosh.Email

  use Phoenix.Swoosh,
    template_root: "lib/marketingbsm_web/templates",
    template_path: "emails"

  alias Marketingbsm.Mailer
  ...
  defp deliver(user, url, subject, template) do
    email =
      ...
      |> subject(subject)
      |> render_body(template, %{the_email: to_string(user.email), name: user.name, url: url})
      |> attachment(
        "priv/static/images/FotoJet.png"
        |> Path.absname()
