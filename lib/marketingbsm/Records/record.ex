defmodule Marketingbsm.Record do
  use Ash.Domain

  domain do
    description """
    This Domain holds Resources related to the Project Records
    """
  end

  resources do
    resource Marketingbsm.Record.Report do
    ...
    resource Marketingbsm.Record.Registry do
      # Define an interface for calling resource actions.
      # We use the Function when we executing code
      # <Function> <Action>
